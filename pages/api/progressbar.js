...
export default function handler(req, res) {
  ...
  res.status(200).send(webpage("Progress Bar",`<script> const progval = ${req.query.p}; let xval = ${ (typeof(req.query.x) !== 'undefined' ) ? req.query.x : 50 }; let yval = ${ (typeof(req.query.y) !== 'undefined' ) ? req.query.y : 50 }; </script>`,
                                              `<div id="progress"></div>
